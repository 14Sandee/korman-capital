                ...
                <Box maxW={{ base: 'xl', md: '7xl' }} mx="auto" px={{ base: '6', md: '8' }}>
                    <Stack spacing={{ base: 6, md: 20 }}>
                        <Stack spacing={0} alignItems={'center'}>
                            ...
                            <Image mt={{ base: 0, md: -10 }} w={'full'} src={HeroImage} alt="hero image" />
                        </Stack>
                        <Stack px={{ base: 0, md: 10 }} spacing={4}>
                            <Heading mb={4} fontSize={{ base: '2xl', md: '4xl' }} color={'secondary.500'} fontFamily={'RecifeDisplay-Italic'} fontWeight={'semibold'}>Korman Capital is a Sebi registered investment advisory firm.</Heading>
                        ...
                        <Stack px={{ base: 0, md: 10 }} spacing={4}>
                            <Heading mb={4} fontSize={{ base: '2xl', md: '4xl' }} color={'secondary.500'} fontFamily={'RecifeDisplay-Italic'} fontWeight={'semibold'}>Clientele</Heading>
                            <SimpleGrid columns={[1, 4]} spacing={4}>
                                {data.map((item: ClientsProps) => <Stack spacing={0} rounded={20} overflow={'hidden'}>
                                    <Stack spacing={4} px={{ base: 4, md: 8 }} py={{ base: 4, md: 8 }} bg={'primary.500'} >
                                        <Heading fontSize={{ md: '3xl', base: 'xl' }} color={'white'} textAlign={'center'} fontFamily={'RecifeDisplay'} fontWeight={'regular'}>{item.name}</Heading>
                                    </Stack>
